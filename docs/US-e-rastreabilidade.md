...
| Rafael Amorim | Como aluno que concluiu um curso com média final 9,0, quero receber três cursos adicionais, para continuar avançando após uma aprovação com nota alta. | [Liberar com média 9,0](Rafael.md) | `deveLiberarTresCursosQuandoAlunoConcluirComMedia9()` |
